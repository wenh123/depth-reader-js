...
function o(a,b,c){a=a.subarray(b,b+c);try{return String.fromCharCode.apply(null,a)}catch(d){for(
// work around PhantomJS bug:
// https://github.com/ariya/phantomjs/issues/11172
var e=-1,f=a.length,g=new Array(f);++e<f;)g[e]=a[e];return String.fromCharCode.apply(null,g)}}
// parse '1'/'true'/'yes'
